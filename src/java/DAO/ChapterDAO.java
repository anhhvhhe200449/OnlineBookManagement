...
public class ChapterDAO extends DBContext{
    ...
    public boolean insertChapter(int bookID, int chapterNumber, String ChapTitle, String content) throws SQLException{
        ...
        String sql = "INSERT INTO Chapters(bookID, chapterNumber, ChapTitle, content) VALUES (?, ?, ?, ?)";
        try{
            PreparedStatement ps = connection.prepareStatement(sql);
    ...
    public Chapter getNext(int chapterNumber, int bookID){
        String sql = """
                     SELECT TOP 1 *
                     FROM Chapters
                     WHERE bookID = ?
    ...
    public Chapter getPrev(int chapterNumber, int bookID){
        String sql = """
                     SELECT TOP 1 *
                     FROM Chapters
                     WHERE bookID = ?
